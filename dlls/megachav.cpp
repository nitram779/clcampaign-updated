...
//=========================================================
#define MEGACHAV_AE_ATTACK 0x01
...
bool CMegachav::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
...
void CMegachav::HandleAnimEvent(MonsterEvent_t* pEvent)
{
	switch (pEvent->event)
	{
	case MEGACHAV_AE_ATTACK:
	{
		// do stuff for this event.
		//		ALERT( at_console, "Slash right!\n" );
		CBaseEntity* pHurt = CheckTraceHullAttack(70, gSkillData.megachavDmgSlash, DMG_SLASH);
		if (pHurt)
		{
...
void CMegachav::Spawn()
{
	...
	pev->health = gSkillData.megachavHealth;
...
int CMegachav::IgnoreConditions()
{
