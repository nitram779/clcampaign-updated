...
const char* CSkeleton::pDeathSounds[] =
	{
		"spooky/s_die.wav",
		"spooky/s_die2.wav",
		"spooky/s_die3.wav",
...
bool CSkeleton::TakeDamage(entvars_t* pevInflictor, entvars_t* pevAttacker, float flDamage, int bitsDamageType)
{
...
void CSkeleton::HandleAnimEvent(MonsterEvent_t* pEvent)
{
	...
	case SKELETON_AE_ATTACK_RIGHT:
	{
		...
		CBaseEntity* pHurt = CheckTraceHullAttack(70, gSkillData.skeletonDmgOneSlash, DMG_SLASH);
		if (pHurt)
		{
	...
	{
		// do stuff for this event.
		CBaseEntity* pHurt = CheckTraceHullAttack(70, gSkillData.skeletonDmgBothSlash, DMG_SLASH);
		if (pHurt)
		{
			if ((pHurt->pev->flags & (FL_MONSTER | FL_CLIENT)) != 0)
			{
...
void CSkeleton::Spawn()
{
	...
	pev->health = gSkillData.skeletonHealth;
...
int CSkeleton::IgnoreConditions()
{
