...
CGrenade* CGrenadeRock::ShootTimed(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity) { return 0; }
CGrenade* CGrenadeFedora::ShootTimed(entvars_t* pevOwner, Vector vecStart, Vector vecVelocity) { return 0; }
